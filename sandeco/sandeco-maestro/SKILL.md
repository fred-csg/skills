...
O esquadrão utiliza uma pasta oculta na raiz do projeto para se comunicar:
...
- NUNCA editar um arquivo se existir um .lock ativo em `.antigravity/equipe/travas/`.
